...
-- Attività recente di un amico: security definer per leggere il progresso
-- streaming di un altro utente SOLO se è un amico accettato (are_cloud_friends).
-- Espone i titoli visti di recente per la pagina profilo dell'amico.
...
-- Annunci globali app (manutenzione, avvisi, messaggi dev)
